...
<html lang="en">
  ...
  <body class="latin contents">
    ...
    <p>An Egyptian pyramid is a very clear statement: it is a picture of a society,
      stressing its hierarchy. Like sociery, every higher layer of the building rests on, is
    ...
    <p>
      In the Homeric context, a 'commoner' is typically the head of an οἶκος (household), a landowner with extended family and
      ...
      he may have judicial authority and catch bribes. Or simply the patronage power: it was a harsh
