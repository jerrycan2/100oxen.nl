...
<?php $lastModified=filemtime(__FILE__);
...
<meta name="Description" content="Introduction to the site and its purpose and the 5 major axioms of my interpretation"><title>100 oxen, a hecatomb and a price to pay</title>
...
<figure><a class="piclink" href="images/Characters-in-the-Iliad.jpg" target="_blank"><img class="fitpage" src="images/Characters-in-the-Iliad.jpg" alt="some of the oxen" width="60%"></a> <figcaption>Some
of the oxen.</figcaption>
</figure>
<h1>Introduction</h1>
<p>You really should go and see the oldest movie we know of - the
Iliad. For us this may be just an old book, a hard-to-read one, but for
Homer's audience it must have been much more like a movie. Sound-only,
all the roles played by one actor, but the medium is definitely like a
movie, a genuine blockbuster if ever there was one. Let me compare it
to a modern epic tale of war and heroism, the "Lord of the Rings"
(movie) and explain why I deem the Iliad to be several levels higher as
a work of art and human interest even if we have to work harder to
...
know, for it is always the same: we shall be brave. No surprises here.
But there is a lot more to be said about it, let us take a brief look
at the differences.</p>
...
The evil is just that: unredeemable, to be utterly despised and
...
passions are awakened, but it does not know evil. Take a moment to
realize how rare this is especially because, as I will argue, the
Trojan War that Homer describes stands for a war going on or
threatening in Homer's time. He lived in a society that was <em>always</em>
at war (Il 14.85-). It is by no means the case that the poet (let alone
the public) is 'objective' or above the parties, he is very much a
Greek and he knows that his audience is, too. Yet he paints the real
...
may not make us feel better. Yet the poem knows and shows with emphasis
that the fighting has to be done, there is no escape from it. That is
what Achilles tried to do and it cost him Patrocles.</p>
...
<p>Some would object to this. What Homer does is not so far from
the 'love your enemy like yourself' that another prophet tried (and failed) to teach
us. Our war-time leaders as well as the voice of heroism, e.g. Nestor
in the Iliad, would see this as potential weakness on our side. Love
...
<p>δῶρα δ'Ἀχιλλῆϊ φερέμεν τά κε θυμὸν
ἰήνῃ&nbsp;&nbsp;&nbsp;&nbsp; </p>
<p><br>
</p>
</div>
...
<p>Trying to discover a poet like that is a bit like like
...
axioms, since they cannot be proved. The only point is how well they
work:</p>
<div class="accheader"> <button class="accordion">1.
These are very carefully crafted, unified texts, the Iliad more so than
the Odyssey. </button>
</div>
<div class="panel">
...
easy on the listener. All-pervasive ring-composition also has a lot to
do with this clarity and this website aims to bring this out. </p>
<p>If you think of 'oral composition' not as well-rehearsed
improvisation but as an author creating a poem inside his head, knowing
...
visible, more about this <a class="textlink" title="structure" href="stitches.php">elsewhere</a>.
</p>
...
This is what I think this 'thematic structure' is a trace of. It is not
a formal structure, it may not even be meant for the listener, but for
the poet himself. More about writing <a class="textlink" target="_self" title="writing" href="writing.php">here</a>.
</p>
<p>The Odyssey presents a much less unified picture. Taking a
...
<div class="accheader"> <button class="accordion">2.
The Iliad is fiercely rhetorical (on two levels).</button>
</div>
<div class="panel">
<p>Homer is the first creator (that we know of<a class="ptr">(2)</a>)
of an <em>icon</em> with all the persuasive power that
implies. I would even say '<a class="textlink" title="scapegoat" href="goat.php">religious power</a>'
...
surely took their model from him. </p>
<p>Painting not in pictures but in words, Homer knows the first
...
23.176).</p>
<p>Just like Odysseus in his efforts to calm down the people in
the second assembly (Il 2.188-206), Homer uses a two-pronged attack:</p>
<br>
<p>a) to commoners:<b> learning by pathos</b> (hit
...
at least at some level. Like young men of all times, potentially angry
...
the figures of Achilles and Hector.</p>
<p><br>
</p>
<p>b) to 'kings and prominent people': <b>allusion </b>(persuade
them with arguments). Here is a sharp criticism of Ionian politics of
...
with ethics meaning 'this is how we are'. </p>
<p> This manner of speaking, the use of language with both public
...
aristocrat, one familiar with power and leadership. </p>
</div>
<div class="accheader"> <button class="accordion">3.
They are about Homer's own time and place </button>
</div>
<div class="panel">
...
was a common use of myth. One example of this is the political use of <a class="textlink" href="history.php">charter myth</a>.&nbsp;
...
in Homer's time, to explain and legitimize Greek presence on and
...
did this within a society at war (at least locally, in Ionia) is a very
...
between Zeus and Poseidon. More about this <a class="textlink" href="poseidon.php">here</a>.</p>
</div>
<div class="accheader"> <button class="accordion">4.
Their self-reflection: in spite of their anonymity, both Homeric poems
are very self-aware, the Odyssey more so than the Iliad. </button>
</div>
<div class="panel">
<p>Never forget that these are not books, they are songs and they
came out of the composer's mouth while he lived. While singing a direct
speech by one of his characters, he virtually becomes that character.
Homer shows himself very aware of this curious position.</p>
<p>The poetic centre of self-reflection is the lyre-playing god
...
in general but also the setting for performances of the poem<a class="ptr">(2)</a>. In this light, the Iliad begins
...
<div class="accheader"> <button class="accordion">5.
These remarkable <em>gods</em> are to be taken seriously
and they belong to Homer only </button>
</div>
<div class="panel">
<p> Homer's view of the gods is not naive and not characteristic
of the Greeks in general. Nor are they there for 'comic relief' only
...
this is the 'Judgement of Paris', the prelude to the Trojan War. The
Olympic scenes sometimes tie in with self-reflection: the way the gods
watch us is like the way we, the listeners, carefree but committed,
fascinatedly watch the characters in the story. We are <em>like</em>
...
Zeus in Il 14.153-. More about the gods <a class="textlink" title="about the gods" href="thegods.php">here</a>.
</p>
</div>
<br>
<p>It must be clear that the Iliad is <em>not a novel</em>.
It is not about an individual or his/her character, it is generic:
about us and our actions. What do we do and why do we do it. Individual
character is not the driving force of the hero's actions. The gods are:
without the gods we are mere bellies. Homer splits us up in eight
'types' (see <a class="textlink" title="Agamemnon's council" href="council.php">Agamemnon's council</a>). Then he
shows us how we are like Achilles in different ways in our actions. He
is also trying to teach us to 'recognize the gods', i.e. to know
ourselves. This is why Athena is the most important one, why Zeus has
high hopes for her (Il 8.406-), and why she should be thoroughly
understood with all her (sometimes contradictory) characteristics.
Recognizing Athena is a trope in both the Iliad and the Odyssey.
</p>
<br>
<hr>
<aside> </aside>
...
tale of the birth of Heracles. Achilles is not a Heracles: Heracles is
