...
<head><?php $lastModified=filemtime(__FILE__);
...
<p>You really should go and see the oldest movie we know of - the
    ...
    I think we can learn from it. There were a lot of things that we know and
...
<p>In the Iliad on the other hand there is <em>no evil</em>.
    ...
    in Homer's own time. He lived in a society that was <em>always</em>
...
<p> Achilles' great rampage (books 20, 21) may establish his
    ...
    in the guise of Odysseus (Il 19.198-). See <a class="textlink"
            title="The Mortal Hero" href="achilles.php">The Mortal Hero</a>
</p>
<br>
...
<div class="panel">
    ...
    <p>This oral-composition hypothesis is related to the poetic
        ...
        the poet himself. More about writing <a class="textlink" target="_self" title="writing"
...
<div class="accheader">
    <button class="accordion">3.
        They are about Homer's own time and place
    </button>
</div>
<div class="panel">
    <p>The Iliad refers to a historical reality in two ways: as a
        ...
        was a common use of myth. One example of this is the political use of <a class="textlink" href="history.php">charter
            myth</a>.&nbsp;
...
<div class="accheader">
    <button class="accordion">4.
        ...
        are very self-aware, the Odyssey more so than the Iliad.
    </button>
</div>
<div class="panel">
...
<div class="accheader">
    <button class="accordion">5.
        These remarkable <em>gods</em> are to be taken seriously
        and they belong to Homer only
    </button>
</div>
<div class="panel">
