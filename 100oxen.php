...
<div class="panel">
    <p>Homer is the first creator (that we know of<a class="ptr">(1)</a>) of an <em>icon</em>
        with all the persuasive power that implies. I would even say 'religious
        power' and that&nbsp; would not be&nbsp; wrong, but we modern people
        have been brought up with a very different view of religion and this
        leads to all kinds of misunderstandings. Later, the Christian church of
        course disagreed with the image of Achilles and created new icons and
        saint-heroes of its own. They surely took their model from him. </p>
    ...
    <p>a) to commoners:<b> learning by pathos</b>(hit
        ...
        male, aristocratic (all little Achillesses), eager for honor and glory
        and very much pro-Greek. This is the public that the literal level of
        meaning is aimed at: wildly enthusiastic, the heart swelling with pride
        with every Greek heroic act. He could control their pity and fear
        (another Aristotle reference here) as well as other emotions like no
        other poet could. This way of frightening them into submission, as
        Odysseus does and as Homer does with his Achilles icon, was attacked by
        Plato who called it 'being courageous through fear' meaning fear of
        shame. The Iliad is very much a poem about shame (Il 24.44, Apollo to
        the gods):</p>
    <p><br>
    </p>
    <div style="margin-left: 80px;">
...
<div class="panel">
    <p>The Iliad refers to a historical reality outside itself and outside the
        ...
        use of myth. One example of this is the political use of <a class="textlink"
                                                                    ...
                                                                    href="history.php">charter-myth</a>.&nbsp; The
...
<div class="panel">
    ...
    <p>In these pages I am mainly concerned with pointing out some of the
        ...
        which make me believe that Homer had a daughter (ref. <a class="textlink"
                                                                 ...
                                                                 target="_self" title="women" href="women.html">Nausikaa,
            Kalypso,
    ...
    <p>Examples of reference to the poem, are abundant from the first moment.
        The meal (dais) is a keyword, being a metaphor for life in general but
        also the setting for performances of the poem. The Iliad begins with a
        rather shocking reference to it being a 'feast for the dogs and birds'
        (Il 1.4-5). This is how Homer sees it, I think. The poem <strong>is</strong>
        the 'wrath of Achilles' and also the wrath of Apollo. Scores of people
        die in it and the listeners enjoy all this at a great feast. And because
        it is about them, you could say they are 'killed by Apollo' and his
        arrows. In the Odyssey's climactic slaughter, the poet does it all over
        again: he slaughters everyone at a feast. </p>
...
<div class="panel">
    ...
    <p>The key concept in approaching Homer's gods, is seeing that they are
        ...
        and likewise in the Iliad. </p>
    <p>It must be clear that the Iliad is <em>not a novel</em>. It is not
        about character, it is about <em>action</em> (Aristotle said this).
        Action here is not determined by individual character but by <em>position</em>.
        With 'position' I mean the sum of the forces acting upon a person when
        he/she is making a decision, such as social status and expectations of
        others but also, in Homeric terms, a choice 'which god to obey'. About
        the gods <a class="textlink" title="what we obey" href="thegods.php">here</a>.
        I do not mean to say that the characters in the poem are only types.
        Homer is too good a poet for that. We could say they are not without
        character, but individual character is not the driving force of their
        actions. The gods are. </p>
    <p><br>
    </p>
</div>
<p><br>
...
<hr>
<ol id="footnotes">
    <li>There is Heracles who looks older than Achilles but we have no idea how this icon came into being.
    </li>
</ol>
<br>
<br>
