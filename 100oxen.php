...
<section>
    <h1>Introduction</h1>
    <p>This is an experimental website about the Iliad and the Odyssey,
        by no means ready for publication, only available because
        people ask me about it. It is
        ...
        to see how far I get building a 'topical structure' of the whole Iliad as
        shown in the <em>collapsible tree</em>. Second, to try out a
    ...
    <p>The 'topical structure' and the self-reflection do not depend
        on each other, you
...
<section>
    ...
    <p>A hundred oxen for slaughter, a hecatomb, that is the Iliad. A feast for
        ...
        prophet or seer. His <b>epiphany</b> is here (Il 24.173, Iris to Priam):</p>
    <br>
    <h5>Homer's mission statement</h5>
    <div class="indent">
        <p>... Διὸς δέ τοι ἄγγελός εἰμι,</p>
        <p>ὅς σευ ἄνευθεν ἐὼν μέγα κήδεται ἠδ' ἐλεαίρει.</p>
        <p class="accented">λύσασθαί σ' ἐκέλευσεν Ὀλύμπιος Ἕκτορα δῖον,</p>
        <p class="accented">δῶρα δ'Ἀχιλλῆϊ φερέμεν τά κε θυμὸν ἰήνῃ&nbsp;&nbsp;&nbsp;&nbsp; </p>
        <p><br>
        </p>
    </div>
    <div class="indent">
        ...
        <p class="accented">The Olympian orders you to ransom the great Hector,</p>
        <p class="accented">bringing gifts to Achilles to melt his heart' </p>
        <p><br>
        </p>
    </div>
    <h5>his public</h5>
...
<section>
    ...
    <section>
        <div class="accheader">
            <h5 class="accordion">1. The Iliad is fiercely rhetorical (on two levels).</h5>
        </div>
        <div class="panel">
            ...
            <p>a) to commoners:<b> learning by pathos</b>(hit them with the sceptre).
                ...
                little Achillesses), eager for honor and glory and very much philhellene.
        ...
        <div class="accheader">
            <h5 class="accordion">2. The Iliad is about about Homer's own time and
                place
            </h5>
        </div>
        <div class="panel">
            <p>The Iliad refers to a historical reality outside itself and outside the
                ...
                use of myth. One example of this is the political use of <a class="textlink"
                                                                            ...
                                                                            href="history.php">charter-myth</a>.&nbsp;
                The
        ...
        <div class="accheader">
            <h5 class="accordion">3. They are very carefully
                crafted, unified texts.
            </h5>
        </div>
        <div class="panel">
        ...
        <div class="accheader">
            <h5 class="accordion">4. Their self-reflectiveness: in spite of their
        ...
        <div class="panel">
            ...
            <p>In these pages I am mainly concerned with pointing out some of the
                ...
                which make me believe that Homer had a daughter (ref. <a class="textlink"
                                                                         ...
                                                                         target="_self" title="women" href="women.php">Nausikaa,
                    Kalypso,
        ...
        <div class="accheader">
            <h5 class="accordion">5. These remarkable <em>gods</em> are to be taken
    ...
    <p>It must be clear that the Iliad is <em>not a novel</em><a class="ptr">(2)</a>.
        It is not about an <em>individual</em> or his/her
        character, it is about <em>us</em> and our actions. What do we do and why do we do it. <!--Actions here-->
        <!--are not determined by individual character but by <em>position</em>. With-->
        ...
        Remember, without the gods we are mere bellies. The poet is trying to teach us to 'recognize the gods', i.e. to know ourselves. This is why Athena is the most important one, why Zeus has high hopes for her (Il 8.406-), and why she should be thoroughly understood with all her (sometimes contradictory) characteristics. Recognizing Athena is a trope in both the Iliad and the Odyssey.
        <!--The concepts of 'inside' and 'outside', character and e.g. social expectations, is not a useful dichotomy to make when analyzing Homeric character.-->
    </p>
</section>
<br>
<hr>
<aside>
    <ol id="footnotes">
        <li>There is Heracles who must be older than Homer's Achilles but we have no idea
            ...
            Heracles. Achilles is not a Heracles: Heracles is a servant who 'really
            is' a king; Achilles is a king who 'really is' a servant.
        </li>
        <li>The Odyssey is much more like a novel</li>
    </ol>
</aside>
<br>
<br>
