...
<html lang="en">
  ...
  <body class="latin contents">
    ...
    <figure> <img class="fitpage"
          ...
          width="60%"></a>  </figure>
    <p>The thematic structure brings out some oddities in the composition. The
    ...
    <p>Originally, the Embassy to Achilles was in the place of the Deception of
      Zeus. This fits: the Achaeans are desperate and send for Achilles.
      The poet (presumably) decided that the embassy had to be moved
      forward. Phoenix was added to the ambassadors and the scene was partially re-composed. On a reason for this we can, as usual, only speculate. Perhaps he thought
      ...
      refusal to fight, unsatisfactory. Too much climax in a short stretch of poem. But in the
