...
<div id="expltext" class="latin">
    ...
    <p>A useful analogy for the top level is the Chimaera<a class="ptr">(0)</a> (she-goat), a
        ...
        goat as a (scapegoat-)sacrifice, i.e. Patroclus, and the snake as a
    ...
    <p>The point is that the three parts create a balanced structure or <em>ring-structure</em> and the whole
        ...
        <a class="textlink" title="ring structures" href="themata.php">ring-structures</a>
    ...
    <p>The middle part tells us the reality of heroic war. It starts with the
        ...
        Patroclus is the price. Nestor, Agamemnon et al. are quite willing to pay that price. Their manipulation of Patroclus (the Achilles) is a trick (metis) and Homer makes it quite clear. See <a class="textlink" title="scapegoat" href="goat.php">scapegoat</a>.
    </p>
    <br>
    <hr>
    <a id="3:19.357"></a>
    <h4>III: The Mortal Hero</h4>
    <p>Patroclus, of course, is <em>an Achilles</em>.
        He is "the mortal hero" and the addressee of the poem. The shock and horror of the Achaean
        near-defeat and Patroclus' death are healed by what seems very much like
        a revenge fantasy, the rampage of Achilles. Justice at work again: if
        you want too much (like Patroclus), you pay for it with your life.
    ...
    <ol id="footnotes">
        ...
        <li>a part of the poem with a typical formal structure (arming - marching
            ...
            Agamemnon, Patroclus and Achilles.
        </li>
