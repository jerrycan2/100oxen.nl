...
<ul>
    ...
    <li>the instrument of Fate (the other gods, as in the warning to Diomedes)</li>
    ...
    <li>ironically, any unpredictable higher power "the gods have ordained..."
        <ul>
            <li>a metaphor for the leaders of society. Ref. "the oath by the Styx",
                the foundation of Zeus' reign. (Th 390-). see <a class="textlink" title="the oath" href="politeia.php">here</a>
            </li>
        </ul>
    </li>
    ...
    <li>"<b>what we obey</b>" - the source of any remarkable human action
        <ul>
            ...
            <li>personifications?: Not "mere personification", but "eternal,
                metaphysical forces that drive us all"</li>
        </ul>
    </li>
</ul>
<p>
    Clearly this list does not reflect the awe and reverence that was prominent in Greek public life.
    ...
    This does not mean that they were irreligious or atheist. They had a much less naive view which was not abstract but
    metaphysical.
    This "intellectual" perspective was developed into a philosophical theory by Plato and Aristotle and their
    predecessors
    but I hope to demonstrate from the texts that its roots were already there in the time of Homer and Hesiod.
</p><br>
<h2>Homer's gods</h2>
<p>In Homer, the gods are <em>what we obey</em> when we decide to act.
    When we obey humans, they ironically become gods to us. We may obey nature:
    night, storms, the sea; we are eager to obey heroes (as Patroclus does). And there are
    many gods all of whom may tell us to do different things.
  Because of this power, these are (semi)divine. We obey them, although it is still <em>we</em>
  ...
  That must be
    ...
    are obeying gods.</p>
<p>This is not a new observation but I believe the people of Homer's time have
    ...
    See also <a class="textlink" title="Plato's gods" href="plato_gods.php">Plato's gods</a>.<br>
...
<p>“In Hesiod's time it was not understood what abstractions are [...]. They
    ...
    influence over humans; they must be gods.” I am not so sure about what they
    did or did not understand, but these are not abstractions: these gods are
    metaphysical<a class="ptr">(2)</a> forces that
    ...
    thing) i.e. put our trust in them, "go for it" as they say nowadays,
    then act and hope for the best. Whether Homer is talking about
    actual metaphysical presences or exactly how he
    viewed these forces seems an unanswerable question.</p>
<br>
<p>There are two things that we may obey: rules and desires. I would suggest
    ...
    below. </p>
<p> It should be noted that this intellectual view of the gods has very little to do
    with popular religion. If anyone did subscribe to this view, he would not have
...
<p>Hera, the eldest daughter of Kronos (in Homer, Il 4.59), is married to
    ...
    In the Iliad, Hera is always in conflict with Zeus about her power/status.
    She is the goddess of thumos (spirit), of wanting to be number one.<br>
